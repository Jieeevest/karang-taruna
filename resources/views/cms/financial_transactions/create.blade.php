...
<!-- Header -->
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Tambah Transaksi Keuangan</h1>
        <p class="text-gray-600 mt-1">Masukkan detail transaksi keuangan</p>
    </div>

    <!-- Form -->
    <div class="bg-white border border-gray-200 rounded-lg p-6">
        <form action="{{ route('cms.financial-transactions.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
