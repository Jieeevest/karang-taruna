                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end gap-2">
                            <a href="{{ route('cms.financial-transactions.show', $transaction) }}" class="text-blue-600 hover:text-blue-900">Detail</a>
                            <a href="{{ route('cms.financial-transactions.edit', $transaction) }}" class="text-teal-600 hover:text-teal-900">Edit</a>
