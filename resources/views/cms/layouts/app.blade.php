        ...
        <div class="h-full flex flex-col">
            <div class="flex-1 px-4 py-6 overflow-y-auto">
                ...
                <nav class="space-y-2">
                    ...
                    <!-- Competition Registrations - Ketua, Admin Data, & Anggota -->
                    @if(auth()->user()->isKetua() || auth()->user()->isAdmin() || auth()->user()->isAnggota())
                    <a href="{{ route('cms.competition-registrations.index') }}" class="flex items-center p-3 text-gray-700 rounded-lg menu-item @if(request()->routeIs('cms.competition-registrations.*')) menu-item-active @endif">
                        <svg class="w-5 h-5 mr-4" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path>
                            <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"></path>
                        </svg>
                        <span class="font-medium">Pendaftaran Lomba</span>
                    </a>
                    @endif
                    ...
                    <!-- Administrasi Section - Ketua, Admin Data, & Anggota -->
                    @if(auth()->user()->isKetua() || auth()->user()->isAdmin() || auth()->user()->isAnggota())
                    <div class="pt-4 pb-2">
                        <p class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Administrasi</p>
                    </div>
                    
                    <a href="{{ route('cms.financial-transactions.index') }}" class="flex items-center p-3 text-gray-700 rounded-lg menu-item @if(request()->routeIs('cms.financial-transactions.*')) menu-item-active @endif">
                        <svg class="w-5 h-5 mr-4" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <a href="{{ route('cms.meetings.index') }}" class="flex items-center p-3 text-gray-700 rounded-lg menu-item @if(request()->routeIs('cms.meetings.*')) menu-item-active @endif">
                        <svg class="w-5 h-5 mr-4" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z"></path>
                        </svg>
                        <span class="font-medium">Rapat Koordinasi</span>
                    </a>
                    
                    <a href="{{ route('cms.documents.index') }}" class="flex items-center p-3 text-gray-700 rounded-lg menu-item @if(request()->routeIs('cms.documents.*')) menu-item-active @endif">
                        <svg class="w-5 h-5 mr-4" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd"></path>
                        </svg>
                        <span class="font-medium">File Dokumen</span>
                    </a>
                    @endif
                </nav>
            </div>
