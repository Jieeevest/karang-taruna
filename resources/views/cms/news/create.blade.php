...
<div class="mb-6">
    <div class="flex items-center space-x-4">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Tulis Berita</h1>
            <p class="text-gray-600">Buat artikel atau berita baru</p>
        </div>
    </div>
</div>
        ...
        <form action="{{ route('cms.news.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Akan ditampilkan di daftar berita dan meta description.</p>
                    @error('excerpt')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
